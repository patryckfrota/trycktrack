...
export function LiquidGlassButton({
  ...
  useEffect(() => {
    const styleId = "liquid-glass-button-style";
    if (!document.getElementById(styleId)) {
      const style = document.createElement("style");
      style.id = styleId;
      style.textContent = `
        .liquid-glass-shader-container canvas {
          width: 100% !important;
      ...
      >
        ...
        >
          ...
          >
            <div
              ref={shaderRef}
              className="liquid-glass-shader-container"
              style={{
                borderRadius: 100,
                overflow: "hidden",
                position: "relative",
          ...
          {ripples.map((ripple) => (
            <span
              ...
              style={{
                ...
                pointerEvents: "none",
                animation: "liquid-glass-ripple 0.6s ease-out",
              }}
            />
          ))}
        </button>
